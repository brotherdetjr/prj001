...
class DepartureBoardRenderer:
    ...
    def __init__(self, station_name: str = ""):
        ...
        self.header_font = self._load_font(display_config.HEADER_FONT_SIZE)
        self.table_font = self._load_font(display_config.TABLE_FONT_SIZE)
        self.row_font = self._load_font(display_config.ROW_FONT_SIZE)
    ...
    def draw_header(self):
        ...
        y_pos = display_config.HEADER_HEIGHT
    ...
    def draw_table_headers(self):
        ...
        y_pos = display_config.HEADER_HEIGHT + 5
        ...
        y_pos = display_config.HEADER_HEIGHT + display_config.TABLE_HEADER_HEIGHT
        self.draw.line([(0, y_pos), (self.width, y_pos)], fill=display_config.YELLOW, width=1)

    def draw_service(self, service: TrainService, row_index: int):
        """Draw a single service row."""
        y_pos = display_config.HEADER_HEIGHT + display_config.TABLE_HEADER_HEIGHT + 5 + (row_index * display_config.ROW_HEIGHT)
    ...
    def render(self, services: List[TrainService]) -> Image.Image:
        ...
        max_rows = (self.height - display_config.HEADER_HEIGHT - display_config.TABLE_HEADER_HEIGHT - 5) // display_config.ROW_HEIGHT
